<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ciudad.aspx.cs" Inherits="test.Sources.Pages.WebForm2" %>
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="/Sources/pages/Ciudad.aspx">Ciudades</a>
                    </div>
                </div>
            </li>
...
<div class="modal fade" id="crud" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <!-- código propio JS --> 
    <script type="text/javascript" src="/Sources/JavaScript/Ciudad.js" async></script> 
